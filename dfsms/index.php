...
<i class="fa fa-eye" style="margin-top: 13px;margin-left: -25px;cursor: pointer" id="showpass" name="showpass" onclick="showpassword()"></i>
</div>
</div>
</div>
                              
<button class="btn btn-warning btn-block" type="submit" name="login">Login</button>
<p class="font-14 text-center mt-15"><a href='javascript:void(0)' onclick='showalert()'>Having trouble logging in?</a></p>
...
<script>
    var showalert = function(){
        alert("We will look into your problem ...keep touch with us");
    }
</script>
    <!-- jQuery -->
