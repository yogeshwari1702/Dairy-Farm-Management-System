                ...
                if(in_array($productByCode["id"],array_keys($_SESSION["cart_item"]))) {
                    foreach($_SESSION["cart_item"] as $k => $v) {
                            if($productByCode["id"] == $k) {
                                ...
                                $quantityToAdd = isset($_POST["quantity"]) ? (int)$_POST["quantity"] : 0;

                                // Check if $_SESSION["cart_item"][$k]["quantity"] is set and is numeric, if not initialize it
                                if (!isset($_SESSION["cart_item"][$k]["quantity"]) || !is_numeric($_SESSION["cart_item"][$k]["quantity"])) {
                                    $_SESSION["cart_item"][$k]["quantity"] = 0;
                                }
